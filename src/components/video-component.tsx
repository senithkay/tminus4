        ...
        <div className="relative w-full mx-auto">
            <div className="relative aspect-video bg-black overflow-hidden">
                ...
                <div className={'absolute z-[11] text-white flex flex-col justify-center items-center w-full h-full'}>
                    ...
                    <p className={'max-w-[600px] text-gray-400 text-2xl text-justify'}>Our vision is to empower businesses with cutting-edge software solutions that drive innovation and success. We are committed to delivering exceptional products and services that exceed our customers' expectations.
