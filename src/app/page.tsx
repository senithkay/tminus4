                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-gray-400 max-w-[800px] text-center text-lg">
                        Our software solutions empower businesses to innovate,
                        scale, and thrive in the digital age. Experience
                        seamless integration, data-driven insights, and
                      ...
                      >
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                          ...
                          >
                            ...
                            <p className={""}>
                              Our team of experienced developers can create
                          ...
                          <div
                            className={
                              "mx-auto w-[300px] hover:scale-[1.03] transition-all duration-500 h-[275px] rounded-[20px] card-shadow-primary-purple  p-[20px] flex flex-col gap-[20px] justify-center"
                            }
                          >
                            <ConstructionIcon className={"text-6xl"} />
                            <h3
                              className={"text-2xl"}
                            >{`Pre-built Software Solutions`}</h3>
                            <p
                              className={""}
                            >{`Offering pre-developed software that can be quickly customized and deployed.`}</p>
                          </div>
                          <div
                            className={
                              "mx-auto w-[300px] hover:scale-[1.03] transition-all duration-500 h-[275px] rounded-[20px] card-shadow-primary-pink  p-[20px] flex flex-col gap-[20px] justify-center"
                          ...
                          >
                            ...
                            <p
                              className={""}
                            >{`Ongoing support and maintenance for existing software solutions, ensuring they remain up-to-date and perform optimally.`}</p>
                          </div>
                          <div
                            className={
                              "mx-auto w-[300px] hover:scale-[1.03] transition-all duration-500 h-[275px] rounded-[20px] card-shadow-primary-purple p-[20px] flex flex-col gap-[20px] justify-center"
                          ...
                          >
                            ...
                            <p
                              className={""}
                            >{`Providing expert advice on software development, implementation strategies, and best practices to improve business processes.`}</p>
                          </div>
                        </div>
                      </div>
                              ...
                              >
                                <div className={"flex"}>
                                  ...
                                  <h3 className="text-6xl font-bold">
                                    <span className={finger.className}>
                                      T - 4
                                    </span>
                                  </h3>
                                </div>
